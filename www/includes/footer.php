<footer class="text-white bg-dark position-absolute bottom-0 start-0 w-100">
  <section class="d-block justify-content-center text-center">
    <!-- Left -->
    <div>
      <p class="text-white">Get connected with us on social networks:</p>
    </div>
    <!-- Left -->
  ...
  <div class="text-center p-4 bg-dark">
    © 2023 Copyright:
    <a class="text-reset text-white fw-bold" href="https://happyDucks.com/">HappyDucks.com</a>
  </div>
</footer>
